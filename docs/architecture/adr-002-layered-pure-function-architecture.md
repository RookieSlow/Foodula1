...
|------|------------|--------|-----------|
| MVPGameManager grows past 1500 lines | Medium | Code becomes hard to navigate | Extracted UIFactory, CarOrientationController, CarMovementAnimator, RaceInputState, RaceLapRules, and RaceTurnRules; input and participation gates are centralized while the next boundary is turn-phase orchestration |
